                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="tipo" id="inlineRadio1"
                                value="credor" >
                            <label class="form-check-label" for="inlineRadio1">{{__('Credor')}}</label>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="tipo" id="inlineRadio2"
                                value="administrador" >
                            <label class="form-check-label" for="inlineRadio1">{{__('Administrador')}}</label>
